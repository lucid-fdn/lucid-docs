...
- [How Agents Work](/concepts/agents) — Understand the agent lifecycle: Init, Plan, Accomplish, Execute, Validate
...
- [Billing & Plans](/platform/billing) — Compare plans and manage your subscription
